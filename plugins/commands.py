...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🆓 Join Sponsored Channel", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**Please Join Sponsored Channel to use this Bot!**",
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('💟 Join Channel 💟', url=(MAIN_CHANNEL)) ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
